  ...
  <div class="min-h-screen">
        ...
        <div class="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
          <div class="text-white">
            ...
            <div class="flex flex-col sm:flex-row gap-4 mb-6">
              <a href="#contact-teaser" class="inline-block">
                <BaseButton
                  variant="secondary"
                  size="lg"
                  class="w-full sm:w-auto !bg-white !text-[#5221a6] hover:!bg-white/90 !border-2 !border-white"
                >
                  Оставить заявку
                </BaseButton>
              </a>
              <BaseButton variant="outline" size="lg" class="w-full sm:w-auto bg-transparent border-2 border-white text-white hover:bg-white/10">
    ...
    <section class="py-16 px-4 bg-gray-50">
      <div class="container mx-auto">
        ...
        <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
          <BaseCard v-for="(feature, index) in featuresRef" :key="index">
    ...
    <section class="py-16 px-4">
      <div class="container mx-auto">
        ...
        <div class="grid grid-cols-1 md:grid-cols-3 gap-8">
          <BaseCard v-for="(device, index) in devicesRef" :key="index">
            <div class="text-center">
              ...
              <div class="grid grid-cols-3 gap-3 mt-6">
                <div 
                  ...
                  :key="i" 
                  class="flex flex-col items-center justify-center p-3 bg-gray-50 rounded-lg hover:bg-gray-100 transition-colors min-h-[80px]"
                  :title="brand.name"
                >
                  <img 
                    ...
                    :src="brand.logoUrl" 
                    :alt="brand.name"
                    class="h-10 w-auto object-contain max-w-full mb-2"
    ...
    <section class="py-16 px-4 bg-gray-50">
      <div class="container mx-auto">
        ...
        <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
          <BaseCard v-for="(service, index) in popularServicesRef" :key="index">
    ...
    <section class="py-16 px-4">
      <div class="container mx-auto">
        ...
        <div class="grid grid-cols-1 md:grid-cols-5 gap-6">
          <div v-for="(step, index) in workStepsRef" :key="index" class="text-center">
    ...
    <section class="py-16 px-4 bg-gray-50">
      <div class="container mx-auto">
        ...
        <div class="grid grid-cols-1 md:grid-cols-3 gap-6">
          <BaseCard v-for="(review, index) in reviewsRef" :key="index">
    ...
    <!-- Contact Teaser -->
    <section id="contact-teaser" class="py-16 px-4 scroll-mt-25">
      <div class="container mx-auto text-center">
        ...
        <div class="flex flex-col sm:flex-row gap-4 justify-center">
          <router-link to="/contacts" class="w-full sm:w-auto">
            <BaseButton variant="primary" size="lg" class="w-full sm:w-auto">Все контакты</BaseButton>
          </router-link>
...
import { features, devices, popularServices, workSteps, reviews } from '@/data/index.js'
...
const devicesRef = ref(devices)
const popularServicesRef = ref(popularServices)
const workStepsRef = ref(workSteps)
